...
```
# Output:
<img width="678" height="432" alt="image" src="https://github.com/user-attachments/assets/6f99b463-a17c-4ac4-b954-d46395129954" />
...
```
# Output:
<img width="641" height="258" alt="image" src="https://github.com/user-attachments/assets/8dd811f1-c42b-43a7-a3e2-41a2be32218b" />
...
```c
    ...
    void printSeries(int lower, int upper)
    {
        if(lower > upper)
            return;
...
```
# Output:
<img width="493" height="175" alt="image" src="https://github.com/user-attachments/assets/27322c4d-4b37-4fa7-ba3f-ebe9b5ee69eb" />
...
```
# Output:
<img width="550" height="421" alt="image" src="https://github.com/user-attachments/assets/3c773439-3445-435b-9ba9-a386f7edeb53" />
...
```
# Output:
<img width="547" height="466" alt="image" src="https://github.com/user-attachments/assets/7b5a537e-70c7-4eba-ac83-2706e1e35d2e" />
